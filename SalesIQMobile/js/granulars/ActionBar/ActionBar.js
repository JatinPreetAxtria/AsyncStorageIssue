                    ...
                    {this.props.rightIcons.map((iconObject, index) => (
                        ...
                        >
                            ...
                            >
                                ...
                                {iconObject.filterCount != null && iconObject.filterCount > 0 &&
                                    <View style={{position:'absolute',top:0,width:25,left:20,height:20,borderRadius:10,backgroundColor:Colors.BID_BTN_COLOR,alignItems:'center',justifyContent:'center'}}>
                                            <Text style={{fontSize:12,fontWeight:'800',color:Colors.white}}>{this.props.filterCount}</Text>
                                    </View>
                                }
                                {iconObject.textName != null &&
                                    <View style={{width:70,height:'100%',alignItems:'center',justifyContent:'center'}}>
                                            <Text style={{fontSize:14,fontWeight:'500',color:Colors.white}}>{iconObject.textName}</Text>
                                    </View>
                                }
                            </View>
                        </TouchableWithoutFeedback>
        ...
        return (
            ...
            >
                ...
                {this.props.filterCount > 0 &&
                    <Image source={ImageAssets.gaadi_new_icon}
                    style={[Styles._AppTitleStyle.appTitleStyle,{top:25,left:10}]} />
                }
                    <Text
                        ...
                        style={[
                            ...
                            (this.props.filterCount > 0) ? styles.titleFiltered : this.props.titleStyle,
                        ]}
                    >
                        {this.props.title}
...
const styles = StyleSheet.create({
    ...
    titleFiltered:{height:60,marginLeft:40}
});
