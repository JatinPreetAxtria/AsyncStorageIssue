...
export default class MultiSlider extends React.Component {
  ...
  render() {
    ...
    const markerContainerOne = { top: markerOffsetY - 15, left: trackOneLength + markerOffsetX - 15 }

    const markerContainerTwo = { top: markerOffsetY - 15, right: trackThreeLength + markerOffsetX - 15 };
...
const styles = StyleSheet.create({
  ...
  selectedTrack: {
    ...Platform.select({
      ios: {
        backgroundColor: Colors.BID_BTN_COLOR, //'#095FFF',
      },
      android: {
        backgroundColor: Colors.BID_BTN_COLOR, //'#0D8675',
      },
    }),
  },
  markerContainer: {
    ...
    borderRadius: 15,
    borderWidth: 2,
    borderColor: Colors.BID_BTN_COLOR,
